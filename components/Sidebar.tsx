...
const Sidebar = () => {
  ...
  return (
    <div>
      <div
        className='text-white block xl:hidden m-2 ml-4 mt-3 text-xl'
        onClick={() => setShowSidebar((prev) => !prev)}
      >
        {showSidebar ? <ImCancelCircle /> : <AiOutlineMenu />}
      </div>
      {showSidebar && (
        <div className='xl:w-400 w-20 flex flex-col justify-start gap-10 mb-10 border-r-2 border-gray-500 xl:border-0 p-3'>
